const translations = {
    ...
    "ua": {
        ...
        "Утилита, имитирующая мерцания призраков в игре Фазмафобия и дающая возможность научиться фотографировать призрака.": "Утиліта, що імітує прояви привидів у грі Фазмафобія і дає змогу навчитися фотографувати привида.",
        "- Как использовать?": "- Як використовувати?",
        "В настройках выбрать модель и тип мерцаний, после чего нажать кнопку старт.": "У налаштуваннях вибрати модель і тип проявів, після чого натиснути кнопку старт.",
        ...
        "Смена облика Обакэ:": "Зміна вигляду Обаке:",
        "Выбрать фотоаппарат": "Вибрати фотоапарат",
        "Выбрать тип мерцания": "Вибрати тип проявів",
        "Выбрать модель призрака": "Вибрати форму привида",
        "Тип мерцаний:": "Тип проявів:",
        ...
        "1ый обакэ (12 мерцание)": "1-ий обаке (12 проява)",
        "Они временно не доступен из-за технических ограничений": "Оні тимчасово недоступний через технічні обмеження",
        "Видно": "Видно",
        "Не видно": "Не видно",
        "мс": "мс",
        "Отображение периода мерцаний призрака": "Відображення періоду проявів привида",
        "Индикатор текущего мерцания призрака": "Індикатор поточного прояву привида",
        "Правильное отображения мерцаний в начале охоты": "Правильне відображення прояву на початку атаки",
